...
@Component
public class LatestEnergyMeasurementsReportTask {
	...
	private final String URI = "https://api.triomobil.com/facility/v1/reports/energy/measurements/latest?_sortOrder=ASC&_sortBy=label";
