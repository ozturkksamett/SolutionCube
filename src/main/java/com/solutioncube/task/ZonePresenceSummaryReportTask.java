...
public class ZonePresenceSummaryReportTask implements ITask {
	
	private static final Logger logger = LoggerFactory.getLogger(ZonePresenceSummaryReportTask.class);
