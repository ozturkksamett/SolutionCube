...
public class ZonesTask implements ITask {

	private static final Logger logger = LoggerFactory.getLogger(ZonesTask.class);
	private final String COLLECTION_NAME = this.getClass().getSimpleName().substring(0, this.getClass().getSimpleName().length() - 4);
	private final String URI = "https://api.triomobil.com/facility/v1/zones?_perPage=50";
