...
public class LatestEnergyMeasurementsReportTask implements ITask {

	private static final Logger logger = LoggerFactory.getLogger(LatestEnergyMeasurementsReportTask.class);
