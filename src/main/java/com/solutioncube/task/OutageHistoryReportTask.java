...
public class OutageHistoryReportTask implements ITask {

	private static final Logger logger = LoggerFactory.getLogger(OutageHistoryReportTask.class);
	...
	private final String URI = "https://api.triomobil.com/facility/v1/reports/indoor/outage/history?trackerId=%s&ts.since=%s&ts.until=%s&_perPage=100";
