...
public class SensorCountSummaryReportTask implements ITask {

	private static final Logger logger = LoggerFactory.getLogger(SensorCountSummaryReportTask.class);
