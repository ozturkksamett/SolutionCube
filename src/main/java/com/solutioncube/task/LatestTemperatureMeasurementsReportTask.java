...
public class LatestTemperatureMeasurementsReportTask implements ITask {

	private static final Logger logger = LoggerFactory.getLogger(LatestTemperatureMeasurementsReportTask.class);
