...
public class AlarmRulesTask implements ITask {
	
	private static final Logger logger = LoggerFactory.getLogger(AlarmRulesTask.class);
	private final String COLLECTION_NAME = this.getClass().getSimpleName().substring(0, this.getClass().getSimpleName().length() - 4);
	private final String URI = "https://api.triomobil.com/facility/v1/alarmRules?_perPage=50";
