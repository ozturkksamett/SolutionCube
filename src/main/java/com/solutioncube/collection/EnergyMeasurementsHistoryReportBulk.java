...
public class EnergyMeasurementsHistoryReportBulk implements ITask {

	private static final Logger logger = LoggerFactory.getLogger(EnergyMeasurementsHistoryReportBulk.class);
