...
public class LatestSensorMeasurementReport implements ITask {
	
	private static final Logger logger = LoggerFactory.getLogger(LatestSensorMeasurementReport.class);
